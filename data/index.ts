...
export const projects = [
  {
    ...
    description:
      "A full-stack match making application, built with Next.js and Node.js",
    link: "https://adminpanel.afronetapp.com/",
  },
  {
    title: "Afrique Mobile App",
    description:
      "A financial platform designed to facilitate secure payments between individuals, such as a artisan and an employer. Built using Next.js and GraphQL for real-time interactions and seamless transactions.",
    link: "https://apps.apple.com/us/app/afriquepay/id6739009253",
  },
  {
    title: "RentalBuzz",
    description:
      "A loan disbursement and staff management system, improving financial transparency. Built using React, React Native and Node.js",
    link: "#",
  },
  {
    title: "wiPharmacy Web Application",
    description:
      "A pharmacy  management web application, built with Angular and Node.js ",
    link: "https://pharmacymhbenin.wicarehealth.com/",
  },
  {
    title: "wiWallet Web Application",
    description:
      "A financial management web application engineered to manage the finances of hospital and Clinics using Wicare application, enabling seamless transaction tracking. Built using Angular.js, PHP, and Node.js",
    link: "http://ewalletmhbenin.wicarehealth.com/pages/login.php",
  },
  {
    title: "wiCare Web Application",
    description:
      "An hospital hospital management application, built to enhance the operational efficiency across departments. Built using Angular and Node.js",
    link: "https://mhbenin.wicarehealth.com/",
  },
];
